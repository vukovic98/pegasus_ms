...
import com.ftn.uns.ac.rs.hospitalapp.security.auth.RestAuthenticationEntryPoint;
import com.ftn.uns.ac.rs.hospitalapp.security.auth.TokenAuthenticationFilter;
import com.ftn.uns.ac.rs.hospitalapp.security.auth.TokenAuthenticationProvider;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/auth/login", "/certificate/receive-certificate");
