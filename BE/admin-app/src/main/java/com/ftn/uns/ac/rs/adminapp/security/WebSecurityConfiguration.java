...
import com.ftn.uns.ac.rs.adminapp.security.auth.RestAuthenticationEntryPoint;
import com.ftn.uns.ac.rs.adminapp.security.auth.TokenAuthenticationFilter;
import com.ftn.uns.ac.rs.adminapp.security.auth.TokenAuthenticationProvider;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.GET, "/certificate-request/verify-request","/certificate/checkRevokedExternal");
